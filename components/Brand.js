  ...
  return (
    <>
      ...
      <Animation className={style.animation}>
        <div style={{ height: "100%", color: "white", fontSize: "44px" }}>
          yaha me kuch animation lagana ha{" "}
        </div>
      </Animation>
          ...
          <div className={style.tabbarcontent}>
            ...
            <div className={style.contentsecond}>
              <div className={style.contenttext}>
                ...
                <span style={{ display: "block", textAlign: "center" }}>
                  of monday.com Work OS. Tailor it your way and
                </span>
                <span style={{ display: "block", textAlign: "center" }}>
      ...
      <Customers className={style.Customers}>
        ...
        <Supporting className={style.Supporting}>
          ...
          <div className={style.Supportingsecond}>
            ...
            >
              <div
                className={style.Supportingfont}
              >
                <span style={{ display: "block" }}>
                ...
                <span style={{ display: "block" }}>
                  monday.com, so you can focus on working without limits.
                </span>
              </div>
      ...
      <Award className={style.Award}>
        ...
        <div className={style.AwardSecond}>
          <AwardFeature
            ...
            width="40%"
            height="100%"
            first={"Voted best feature set, relationship and value"}
            second={"“This is the best no-code platform I've ever seen.”"}
          />
          <AwardFeature
            ...
            width="50%"
            height="100%"
            first={"Shortlisted in over 8 software categories"}
            second={"“The perfect organizer and team builder.”"}
          />
          <AwardFeature
            ...
            width="40%"
            height="100%"
            first={"Market leader across 18 categories"}
            second={"“Flexible product with near endless possibilities.”"}
          />
        </div>
      </Award>
      ...
      <Deliver className={style.Deliver}>
        <Center>
        <div>
          <span style={{ display: "block", fontSize: "28px", color: "white" }}>
            Deliver your best work with{" "}
            <span style={{ fontWeight: "bold" }}> monday.com</span>
          </span>
          <span style={{ fontSize: "18px", color: "white", display: "block" }}>
